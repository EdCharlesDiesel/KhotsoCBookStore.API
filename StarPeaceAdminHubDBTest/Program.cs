...
namespace StarPeaceAdminHubDBTest
{
    public static class Program
    {
        ...
        public static void Main()
        {
            ...
            #region Create role
            // var firstRole= new IdentityRole<int> { Name = "Admins",NormalizedName = "ADMINS" };
            
            // context.Roles.Add(firstRole);
            // context.SaveChanges();
            // Console.WriteLine(
            //     "DB populated: first user id is " +
            //     firstRole.Id);
            // Console.ReadKey();
            #endregion
            ...
            #region Create User
             ...
             // var userManager = serviceScope.ServiceProvider.GetService<UserManager<IdentityUser<int>>>();
                ...
                currUser.UserName = user.ToString();
                //new IdentityUser<int> { UserName = user, Email = "admin@fakedomain.com", EmailConfirmed = true,  }, password
