...
{
    public partial class AddedAllEntitiesNewGuid1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumRetail = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ManimumRetail = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSubscriptions", x => x.ProductSubscriptionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSubscriptionItems", x => x.ProductSubscriptionItemId);
                    table.ForeignKey(
                        name: "FK_ProductSubscriptionItems_ProductSubscriptions_ProductSubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSubscriptionItems_ProductSubscriptionId",
