...
{
    public class MemberOrderFullEditViewModel: IMemberOrderFullEditDTO
    {
        public MemberOrderFullEditViewModel() { }
        public MemberOrderFullEditViewModel(IMemberOrder o)
        {
            Id = o.Id;
