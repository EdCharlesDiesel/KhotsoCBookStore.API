...
{
    //! Remember we need to inherit fromcontrollerBase for attributes
    ...
    //     {
    //         return await _userRepository.CheckUserAvailabityAsync(userName);
    //     }
    ...
    //     public  Task<ActionResult> UpdateUser(Guid userId, RegisterDto userToUpdate)
    //     {
